...
public interface DataManagerService {
	public void uploadRawDataAndStoreLocally(MultipartFile file, String urlRepoKey, String localeCode, String feature)
			throws Exception;
...
//	public void downloadDataAndStoreLocally(String urlRepoKey, String path, String feature) throws Exception;
	...
	public JSONArray getDataAsJSON(String urlRepoKey, String path, String[] features, String begin, String end)
			throws Exception;

	public String getDataAsCSV(String urlRepoKeyKey, String path, String[] features) throws Exception;

	public String getDataAsCSV(String urlRepoKey, String path, String[] features, String begin, String end)
			throws Exception;
	...
	public Timeseries getDataAsTimeseries(String urlRepoKey, String path, String temporalIndexer, String[] features,
	...
	public Timeseries getAVGTimeseriesByPeriod(String fileFullName, String[] features, String begin, String end)
			throws Exception;
